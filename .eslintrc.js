module.exports = {
  ...
  rules: {
    ...
    "jax-a11y/control-has-associated-label": "off", //상호 작용하는 엘리먼트에  label을 넣는다.
    ...
    "linebreak-style": 0, //운영체제 마다 개행 차이로 생기는 오류
    "react/function-component-definition": [2, { namedComponents: "arrow-function" }], //react 함수형 컴포넌트 정의 방식 선언
    "no-param-reassign": "off", //param assign 하지 않기
    "jsx-a11y/label-has-associated-contorl": "off",
    "no-invalid-css": "off",
